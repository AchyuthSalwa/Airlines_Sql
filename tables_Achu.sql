...
-- AIRPORTDROP TABLE TRAVEL_AGENCY;

CREATE TABLE TRAVEL_AGENCY(TRAVELAGENCYID NUMBER(10) PRIMARY KEY,
...
MILEAGEEXPDATE DATE,
FOREIGN KEY(FPASSENGERID) REFERENCES PASSENGER(PASSENGER_ID));
